...
class RestaurantMenuRecyclerViewAdapter: RecyclerView.Adapter<RestaurantMenuRecyclerViewAdapter.ViewHolder>() {
    private lateinit var mealList: List<MealModel>
    ...
    fun setData(mealList: List<MealModel>?) {
        mealList?.let {
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(mealModel: MealModel, listener: IMealOnClick?) {
            mealName.text = mealModel.name
            mealPrice.text = mealModel.price
